...
export const projects: Project[] = [
  ...
  },
  {
    ...
    shortDescription:
      "A bilingual web prototype where tarot cards become symbolic prompts for reflective questioning rather than fortune telling.",
    abstract:
      "The Tarot Reflection Website turns a card-reading ritual into an interactive reflective interface. Visitors can enter a question, work with tarot card input, and continue a warm conversational flow that reframes the cards as symbolic anchors. In Creative Coding, this project is presented as a web experience: interface mood, interaction flow, local saved chats, bilingual UI, and the pacing of a reflective browser ritual.",
    tags: [
      "Creative Coding",
    ...
    imageAlt: "Tarot Reflection Website cover screen",
    ...
    gallery: [
      {
        src: "/images/tarot/tarot1.png",
        alt: "Tarot Reflection Website cover interface",
        caption: "Cover screen for the Tarot Reflection Website.",
      },
      {
        src: "/images/tarot/tarot2.png",
        alt: "Tarot Reflection Website interface screenshot 2",
        caption: "Question entry and reflective interaction flow.",
      },
      {
        src: "/images/tarot/tarot3.png",
        alt: "Tarot Reflection Website interface screenshot 3",
        caption: "Card-mediated prompt interface.",
      },
      {
        src: "/images/tarot/tarot4.png",
        alt: "Tarot Reflection Website interface screenshot 4",
        caption: "Bilingual reflective reading interface.",
      },
      {
        src: "/images/tarot/tarot5.png",
        alt: "Tarot Reflection Website interface screenshot 5",
        caption: "Growing reflection state and conversational pacing.",
      },
      {
        src: "/images/tarot/tarot6.png",
        alt: "Tarot Reflection Website interface screenshot 6",
        caption: "Symbolic anchors for continuing the reflection.",
      },
      {
        src: "/images/tarot/tarot7.png",
        alt: "Tarot Reflection Website interface screenshot 7",
        caption: "Summary-style reflection moment.",
      },
      {
        src: "/images/tarot/tarot8.png",
        alt: "Tarot Reflection Website interface screenshot 8",
        caption: "Saved or continued reflective session view.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    image: "/images/tarot-cover.png",
    imageAlt: "Tarot Reflection Demo cover screen",
    route: "/tarot",
    status: "ongoing",
    featured: true,
    whyItMatters:
    ...
    gallery: [
      {
        src: "/images/tarot/tarot1.png",
        alt: "Tarot Reflection Demo cover interface",
        caption: "Cover screen for the Tarot Reflection Demo.",
      },
      {
        src: "/images/tarot/tarot2.png",
        alt: "Tarot Reflection Demo interface screenshot 2",
        caption: "Question entry and reflective interaction flow.",
      },
      {
        src: "/images/tarot/tarot3.png",
        alt: "Tarot Reflection Demo interface screenshot 3",
        caption: "Card-mediated prompt interface.",
      },
      {
        src: "/images/tarot/tarot4.png",
        alt: "Tarot Reflection Demo interface screenshot 4",
        caption: "Bilingual reflective reading interface.",
      },
      {
        src: "/images/tarot/tarot5.png",
        alt: "Tarot Reflection Demo interface screenshot 5",
        caption: "Growing reflection state and conversational pacing.",
      },
      {
        src: "/images/tarot/tarot6.png",
        alt: "Tarot Reflection Demo interface screenshot 6",
        caption: "Symbolic anchors for continuing the reflection.",
      },
      {
        src: "/images/tarot/tarot7.png",
        alt: "Tarot Reflection Demo interface screenshot 7",
        caption: "Summary-style reflection moment.",
      },
      {
        src: "/images/tarot/tarot8.png",
        alt: "Tarot Reflection Demo interface screenshot 8",
        caption: "Saved or continued reflective session view.",
      },
    ],
  },
