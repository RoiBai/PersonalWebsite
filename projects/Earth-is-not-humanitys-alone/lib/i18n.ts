...
export const ui = {
  en: {
    ...
    events: "Verified events", species: "Animal types", span: "Time span", verified: "Last verified", scroll: "Scroll down or move sideways through time",
    archive: "ANIMAL HARM ARCHIVE", timeline: "Horizontal timeline of animal events; scroll vertically or horizontally to advance", keepGoing: "The record continues", scrollAdvance: "scroll ↓ or sideways →", swipe: "Swipe left to continue →",
  ...
  zh: {
    ...
    events: "已核实事件", species: "涉及物种", span: "时间跨度", verified: "最后核实", scroll: "向下滚动或横向滑动，穿行时间线", archive: "动物伤害事件档案", timeline: "动物事件横向时间线；上下滚动或左右滑动均可推进", keepGoing: "记录仍在继续", scrollAdvance: "上下滚动／左右滑动", swipe: "向左滑动，继续时间线 →",
