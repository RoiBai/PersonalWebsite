...
export const projects: Project[] = [
  ...
  {
    id: "her-sound-resound",
    title: "Her sound Resound",
    displayTitle: "Her sound Resound",
    year: 2026,
    type: "game",
    venue: "SheNicest 千人黑客松 · August 2026",
    authors: "北舟, 长尾, Roi",
    platform: "Web · 2D narrative puzzle game",
    status: "released",
    shortDescription:
      "A narrative puzzle game about Shangguan Wan’er and Princess Taiping, exploring women’s agency, political ambition, and historical memory through three-panel storytelling.",
    abstract:
      "Her sound Resound (颂声起) is a 2D narrative puzzle game that explores the intertwined lives of Shangguan Wan’er and Princess Taiping, two influential women of China’s Tang dynasty. Created for the SheNicest 千人黑客松 and completed in August 2026, the project combines traditional Chinese visual aesthetics, comic-style storytelling, and interactive puzzles to examine how women’s lives are represented and remembered in history.\n\nInspired by Storyteller, the game invites players to arrange characters, events, and symbolic objects across three-panel scenes. Through experimentation, players reconstruct moments of literary achievement, political cooperation, and conflict. The first six chapters form eighteen scenes, tracing the protagonists’ different beginnings, their growing connections, and their involvement in the shifting politics of the imperial court. This approach turns historical storytelling into an active process: players build relationships and interpret events through the scenes they assemble.\n\nAs the story progresses, the game shifts its attention from the women’s lives to their historical reputations. The scenes players have constructed gradually fade and fragment, introducing a second question: what happens to a person’s story after her death? The final chapter confronts portrayals that reduce women’s political ambitions to moral failings and their alliances to jealousy or romantic rivalry. By placing a symbol of power into these scenes, players are invited to reconsider the women as political actors with intentions, choices, and agency.\n\nAt its heart, Her sound Resound asks: Who gets to be remembered as a complex human being? The project preserves the protagonists’ tragic outcomes while making space for their talents, ambitions, contradictions, mistakes, and relationships. It uses the emotional involvement of play to encourage reflection on gender and historical memory—and on our own role in deciding which stories continue to be heard.\n\nHistory cannot be replayed, but we can choose how to remember her.",
    tags: [
      "Narrative Puzzle",
      "Historical Memory",
      "Gender & Agency",
    ...
    links: [
      { label: "Play Game", url: "https://she.ruiyuanbai.com" },
      { label: "GitHub", url: "https://github.com/RoiBai/her-song-resounds" },
    ],
    image: "/images/her-sound-resound/cover.jpg",
    imageAlt:
      "颂声起 title screen with ink-drawn clouds and silhouettes of Shangguan Wan’er and Princess Taiping before a Tang dynasty palace",
    imageFit: "contain",
    route: "/games/her-sound-resound",
    whatIDid: [],
    galleryTitle: "Story, playable scenes, and historical memory",
    gallery: [
      {
        src: "/images/her-sound-resound/prologue.jpg",
        alt: "Illustrated prologue with Chinese narration showing Wu Zetian learning of the plot against her and confronting the court",
        caption: "Prologue · Comic panels and narration establish the court conflict behind Wan’er’s beginnings.",
        fit: "contain",
      },
      {
        src: "/images/her-sound-resound/chapter-01.jpg",
        alt: "Chapter one: Shangguan Wan’er’s family loss, literary talent, and appointment by Wu Zetian",
        caption: "Chapter 1 · A minister’s daughter: Wan’er’s beginnings, literary talent, and entry into court life.",
        fit: "contain",
      },
      {
        src: "/images/her-sound-resound/chapter-02.jpg",
        alt: "Chapter two: Princess Taiping’s imperial family, education, and relationship with Wu Zetian",
        caption: "Chapter 2 · An emperor’s daughter: Taiping’s royal upbringing, education, and her mother’s favor.",
        fit: "contain",
      },
      {
        src: "/images/her-sound-resound/shared-court.jpg",
        alt: "Shangguan Wan’er and Princess Taiping beside a palace illustration and Chinese text describing their different backgrounds and growing connection",
        caption: "A shared court · Different beginnings lead to encounters through poetry, banquets, and life in the palace.",
        fit: "contain",
      },
      {
        src: "/images/her-sound-resound/chapter-03.jpg",
        alt: "Chapter three: Shangguan Wan’er and Princess Taiping sharing an outing, a banquet, and poetry",
        caption: "Chapter 3 · Shared journeys and banquets: the protagonists connect through travel, conversation, and poetry.",
        fit: "contain",
      },
      {
        src: "/images/her-sound-resound/palace-upheaval.jpg",
        alt: "Narrative transition showing Taiping and Li Longji on horseback during the Tanglong coup, while Wan’er holds a candle to receive them",
        caption: "Palace upheaval · Illustrated transitions connect political conflict with the protagonists’ choices.",
        fit: "contain",
      },
      {
        src: "/images/her-sound-resound/fading-memories.jpg",
        alt: "Eighteen assembled historical scenes, several fragmenting into particles and fading into the paper background",
        caption: "Fading memories · The scenes players assembled begin to disappear, shifting attention from lived experience to historical remembrance.",
        fit: "contain",
      },
      {
        src: "/images/her-sound-resound/credits.jpg",
        alt: "Development credits featuring illustrated portraits and the names 北舟, 长尾, and Roi",
        caption: "Development team · 北舟, 长尾, and Roi.",
        fit: "contain",
      },
    ],
  },
